...
OUT_FILE="${OUT_FILE:-docs/mock-provider-tuning-latest.jsonl}"
PORT="${PORT:-18789}"
...
PERMITS_LIST="${PERMITS_LIST:-8 16 24}"
QUEUE_WAIT_LIST="${QUEUE_WAIT_LIST:-1000 2000 5000}"
CONCURRENCY_LIST="${CONCURRENCY_LIST:-50 200}"
...
echo "Mock provider tuning $(date -u +%Y-%m-%dT%H:%M:%SZ)" > "$OUT_FILE"
